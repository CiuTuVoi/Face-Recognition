...
from utils.deep_sort_realtime_custom.deep_sort import nn_matching
from utils.deep_sort_realtime_custom.deep_sort.detection import Detection
from utils.deep_sort_realtime_custom.deep_sort.tracker import Tracker
from utils.deep_sort_realtime_custom.utils.nms import non_max_suppression
...
class DeepSort(object):
    def __init__(
        ...
        polygon=False,
        today=None,
        embedder_fn=None  # ✅ THÊM THAM SỐ NÀY
    ):
        ...
        self.embedder_fn = embedder_fn  # ✅ GÁN VÀO ĐỂ SỬ DỤNG VỀ SAU

        if embedder_fn is not None:
            self.embedder = None  # Bạn sẽ truyền embedding thủ công
